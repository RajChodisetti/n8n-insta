...
- the image asset already contains the title text centered in the frame (generated by the image model)
...
- face image title embedded in first scene asset (no additional renderer overlay)
