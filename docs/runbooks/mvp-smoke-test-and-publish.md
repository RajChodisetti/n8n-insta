...
```
6. If you prefer the newer upstream generated-image plus approval path, use [19 — Phase 2 Manual Review and Live Publish Runbook](/Users/rajchodisetti/n8n-insta/docs/runbooks/phase2-manual-review-and-live-publish.md) instead of this MVP shortcut.
...
- If validation fails on a supposed Phase 2 live candidate because the asset URL is local-only, switch the generated-image flow to `POST_IMAGE_HOST_PROVIDER=google_cloud_storage`, recreate `n8n`, rerun `wf_simple_post_image_asset`, and then retry publish. The full generated-image path is documented in [19 — Phase 2 Manual Review and Live Publish Runbook](/Users/rajchodisetti/n8n-insta/docs/runbooks/phase2-manual-review-and-live-publish.md).
